...
- [x] **HOME-03**: Пользователь выбирает тему из 7 (любовь, работа, деньги, выбор, день, саморефлексия, общий вопрос)
- [x] **HOME-04**: Приложение рекомендует расклад по теме (с причиной); пользователь может выбрать другой
- [x] **HOME-05**: Пользователь выбирает колоду в карусели карточек (название, атмосфера, для каких вопросов, preview, тон)
- [x] **HOME-06**: Пользователь выбирает расклад (карточки с количеством карт)
...
- [x] **LIMIT-05**: Anti-abuse/rate-limit через Redis (атомарный throttle на создание раскладов)
...
- [x] **UI-01**: Premium-тёмный UI (стеклянные панели, свечения, градиенты, крупные карты); mobile-first 360–430px; sticky нижняя CTA
...
| HOME-03 | Phase 3 — The Ritual (mock) | Complete |
| HOME-04 | Phase 3 — The Ritual (mock) | Complete |
| HOME-05 | Phase 3 — The Ritual (mock) | Complete |
| HOME-06 | Phase 3 — The Ritual (mock) | Complete |
